...
`remotes::install_github("joachim-gassen/tidycovid19")` 코드를 사요해서 패키지 설치를 해주면 된다.


# 어떻게 사용할 수 있을까

tidycovid19 패키시에서는 많은 함수를 제공해주는데, 다음 코드만 봐도 쉽게 시각화를 할수가 있다.
